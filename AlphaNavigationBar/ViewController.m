...
- (UIView *)obtainHeaderView{
    ...
    avatarView = [[UIImageView alloc] initWithFrame:CGRectMake((screenW-avatarW)/2.0, navRect.size.height+screenW*40.0/1080.0-44.0, avatarW, avatarW)];
    ...
    [titleview addSubview:topAvatarView];
